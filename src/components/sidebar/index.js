...
const Sidebar = () => {
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      navigate('/home');
      window.location.reload(); // Tải lại trang home
    } catch (error) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-tealBGDaskboard overflow-hidden">
      ...
      <div className="flex flex-row mt-20 min-h-screen">
        <div
          className={`w-72 bg-tealDashboard text-black font-bold flex flex-col transform transition-transform duration-300 ${
