...
const BillList = ({ userId, groupId, onActionComplete }) => {
  ...
  // Memoize fetchBillsData using useCallback
  ...
  // Memoize fetchCategoryNames using useCallback
  ...
  }, [userId, groupId, fetchBillsData]); // Adding fetchBillsData to the dependencies array

  useEffect(() => {
    if (bills.length > 0) {
      fetchCategoryNames();
    }
  }, [bills, fetchCategoryNames]);
...
//       console.log('UserID chưa có');
//     }
//   }, [userId, groupId, fetchBillsData]);

//   useEffect(() => {
//     if (bills.length > 0) {
//       fetchCategoryNames();
//     }
//   }, [bills, userId, fetchCategoryNames]);
